...
<!--
	...
	$("#btnKeyPurpose h3").text("แสดงความมุ่งหมายหลัก (Key Purpose) (" + rowCountPurpose +" results)");
	$("#btnKeyRoles h3").text("บทบาทหลัก (Key Roles) (" + rowCountRole +" results)");
	$("#btnKeyFunc h3").text("หน้าที่หลัก (Key Functions) (" + rowCountFuc +" results)");
	$("#btnUnit h3").text("หน่วยสมรรถนะ (Units of Competence) (" + rowCountUnit +" results)");
	$("#btnElement h3").text("สมรรถนะย่อย(Element of Competence) (" + rowCountElement +" results)");
	$("#KeyPurpose").toggle();
	$("#KeyRoles").toggle();
    $("#KeyFunc").toggle();
    $("#Unit").toggle();
