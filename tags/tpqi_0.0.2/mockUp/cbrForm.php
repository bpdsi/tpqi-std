	...
	if($step=="" || $step==1){
		?>
			...
			<!--
				$('document').ready(function(){
					$('.cb_select').click(function(){
							window.open('?page=mockUp/cbrForm.php&step=2','_self');
						}
					);
				});
			//-->
			...
			<table class="table_01" style="margin-left: auto;margin-right: auto;">
				<tr>
					<td class="table_header table_topRadius">[Mock Up] แบบฟอร์มลงทะเบียนขอรับการประเมิน</td>
				</tr>
				<tr>
							...
							<tr>
								<td colspan="2"
									style="
										...
										padding: 20px;
									"
								>เลือกประเภทผู้ขอรับการประเมิน</td>
							</tr>
							<tr>
								<td class="cb_select" style="text-align: center;vertical-align: top;padding: 20px;">
									<img src="mockUp/cb.png" style="height: 150px;"><br>
									<div style="font-size: 30px;font-weight: bold;">ผู้ได้รับการรับรองระบบงาน</div>
									<div>(จากคณะกรรมการมาตรฐานแห่งชาติ)</div>
								</td>
								<td class="cb_select" style="text-align: center;vertical-align: top;padding: 20px;">
									<img src="mockUp/cb.png" style="height: 150px;">
									<div style="font-size: 30px;font-weight: bold;">หน่วยงานทั่วไป</div>
								</td>
							</tr>
						</table>
					</td>
		...
		?>
			...
			<table class="table_01" style="margin-left: auto;margin-right: auto;">
				<tr>
					<td class="table_header table_topRadius">[Mock Up] แบบฟอร์มลงทะเบียนขอรับการประเมิน <input type="button" value="Download PDF" style="float: right;"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="table_footer"><input type="button" value="ส่งใบสมัคร" style="float: right"></td>
				</tr>
			</table>
		<?php
	}
