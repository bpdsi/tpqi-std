...
<!--
	$('document').ready(function(){
		...
		$('.animate').mouseover(function(){
			$(this).stop();
			$(this).animate({height: 40,bottom: 0,margin: 0},'fast');
		}).mouseout(function(){
			$(this).stop();
			$(this).animate({height: 25,bottom: 0,margin: 0},'fast');
		});
	});
//-->
</script>
...
<table style="width: 100%;border: none;background: none;">
	<tr>
		<td valign="top" align="center" style="width: 250px;">
				<img src="images/new.png" width="200"><br>
		...
		<td valign="top">
			<?
				...
				*/
				echo '<table class="tree" style="margin-left: auto;margin-right: auto;display: none;"><tr><td>';
				...
				*/
				...
				mysql_select_db($db);
				//echo "xxxxxxxxxxxx ".$db." xxxxxxxxx<br>";
				...
				$charset = "SET collation_connection =  utf8_unicode_ci   ";  
				mysql_query($charset) or die('Invalid query: ' . mysql_error()); 
				...
				*/
				if (isset($_GET['action'])) {
				    ...
				    case "delete_from_db_wholetreexx":
				        /*
				...
				*/
				if (isset($_POST['child'])&&isset($_POST['detail'])) {
					echo $_POST['node'].",".$_POST['child'].",".$_POST['detail']."<br>";
				    $mytree->insert_into_db($_POST['node'],$_POST['child'],$_POST['detail'], time() );
				    echo "ok";
				}
					/*
					...
					*/
					?>
						<table class="table_01" style="margin-left: auto;margin-right: auto;">
							<tr>
								<td class="table_header table_topRadius">มาตรฐานอาชีพ</td>
							</tr>
							<tr>
								<td><?php $mytree->display_branch($node);?></td>
							</tr>
							<tr>
					...
					<?php
						//echo '<table class="table_01" style="margin-left: auto;margin-right: auto;">';
					//echo "<br><p>display_branch(\$node)</p>";
				    ...
				    */
				    ...
				    ?>
							...
							<tr>
								<td>
				    				<?php
										...
										/*if($branches==1){
											echo "<h3>ความมุ่งหมายหลัก(Key Purpose)</h3>";
										}elseif($branches==2){
											echo "<h3>บทบาทหลัก(Key Roles)</h3>";
										}elseif($branches==3){
											echo "<h3>หน้าที่หลัก (Key Functions)</h3>";
										}elseif($branches==4){
											echo "<h3>หน่วยสมรรถนะ (Units of Competence)</h3>";
										}elseif($branches==5){
											echo "<h3>สมรรถนะย่อย (Element of Competence)</h3>";
										}*/
									?>
								</td>
							</tr>
						...
						<br>
						<table class="table_01" style='margin-left: auto;margin-right: auto;width: 100%;'>
							<tr>
								<td class="table_header table_topRadius" colspan="2">Navigator</td>
							</tr>
							<tr>
								<td style="padding: 10px;"><?php $mytree->display_reverse_path( $node );?></td>
								<td style="padding: 10px;">
									<?php
										echo '\\<a href="?page=tree.php&node=-1">root</a><br>'; echo "xbranch no. ".$branches." in tree"; 
									?>
								</td>
							</tr>
							<tr>
				...
				if ( !isset($mytree->number_of_nodes) || $mytree->number_of_nodes=="0" ) {
				    ...
				    echo '<b>database is empty</b> ... <a href="?page=tree.php&action=populatetree">click here to create a root-node and populate the database with dummy entries</a><br><br>';
				    echo '</td></tr></table>';
				...
				echo '[<a href="?page=tree.php&action=showsource">view source-code</a>] - ';
