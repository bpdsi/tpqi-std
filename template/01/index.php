...
<style type="text/css">
	...
	.menu:hover{
		background-image: url('<?php echo $templatePath?>/images/leftMenuBG.png'), url('<?php echo $templatePath?>/images/rightMenuBG.png');
...
<img src="<?php echo $templatePath?>/images/tpqiDecoration.png"
	style="
		position: fixed;
		right: 0px;
		bottom: 10px;
...
>
	<table class="noSpacing" style="width: 100%;height: 118px;background: none;border: none;">
		<tr>
			<td
				style="
					background-image: url('<?php echo $templatePath?>/images/headerLeft.png');
			...
			<td
				style="
					background-image: url('<?php echo $templatePath?>/images/headerBG.jpg');
				...
				<table class="noSpacing" style="height: 118px;width: 100%;background: none;border: none;">
					<tr>
						<td style="padding-left: 20px;padding-top: 20px;height: 62px;">
							<img id="menu_home" src="<?php echo $templatePath?>/images/title.png" style="margin-top: -10px;">
