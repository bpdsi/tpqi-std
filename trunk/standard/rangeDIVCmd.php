	...
	echo"<table  border='1' class='noSpacing' style='margin-left:auto;margin-right: auto;margin-top: 5px;width:1000px'>
		...
		while($rowrange=mysql_fetch_array($rrange)):
			...
			<td class=\"edit_td\">
				...
				<textarea cols='110' rows='2' class=\"editbox\" id=\"range_name_input_".$i."\">".$rowrange["range_name"]."</textarea>
			</td>
			<td width='15%'><input type=\"button\" id=\"CmdBtn_".$i."\" value=\"บันทึก\" onClick=\"dataManageRange(".$i.");\" ></td>
		</tr>";
		$i++;
		endwhile;
		echo "<tr id=".$i." class=\"edit_range\"valign='top'>
